...
## Configuring Visual Studio Code for Black Formatting

## Configuring Visual Studio Code for Flake8 Linting

## Create your first commit in a Git repository

## Initiate Chat Server Administration App
